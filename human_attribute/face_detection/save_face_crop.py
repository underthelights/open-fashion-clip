...
foreground_pil = Image.open('/home/tidy/PycharmProjects/Air-Clothing-MA/FaceDetection/man_icon.png') #.convert("RGBA")
...
while True:
    ...
    try:
        ...
        if key == 115 or key == 13 and \
            ...
            cv2.imwrite(f'face_detection/user_face_database/{idx}.jpg', biggest_cropped_face)
            idx += 1
        elif key == ord('q'):
            break
    except:
