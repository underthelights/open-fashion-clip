...
def main(args):
    ...
    # assert time.sleep(3), 'Cannot capture source'
        ...
        if ret:
            ...
            if type(detections) != int: 
                if detections.shape[0]:
                    ...
                    detections = detections[small_object_ratio > 0.4]
                    im_dim = im_dim[small_object_ratio > 0.4]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', type=str, default='./module/human_attribute/encoder-12-1170.ckpt', help='path for trained encoder')
    ...
    parser.add_argument('--cfg_file', type = str, default = './module/human_attribute/cfg/yolov3.cfg', help ='Config file')
    parser.add_argument('--weights_file', type = str, default = './module/human_attribute/yolov3.weights', help = 'weightsfile')
    ...
    coco_classes = load_classes('./module/human_attribute/data/coco.names')
    colors = pkl.load(open("./module/human_attribute/pallete2", "rb"))
